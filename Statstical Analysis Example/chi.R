...
#of people visiting.
#Syntax
#The function used for performing chi-Square test is chisq.test(). The basic syntax for creating a chi-square
#test in R is -
#chisq.test(data)
...
#Example
#We will take the Cars93 data in the "MASS" library which represents the sales of different models of car in
#the year 1993.
library("MASS")
print(str(Cars93))
cat("-----------------------------","\n")

#The above result shows the dataset has many Factor variables which can be considered as categorical vari-
#ables. For our model we will consider the variables "AirBags" and "Type". Here we aim to find out any
